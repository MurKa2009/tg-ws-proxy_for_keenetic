...
```bash
curl -sL [https://raw.githubusercontent.com/ТВОЙ_ЛОГИН/tg-ws-proxy-keenetic/main/install.sh](https://raw.githubusercontent.com/ТВОЙ_ЛОГИН/tg-ws-proxy-keenetic/main/install.sh) | sh
